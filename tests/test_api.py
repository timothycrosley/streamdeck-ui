...
auto_pytest_magic(server.get_button_text)
auto_pytest_magic(server.get_button_font)
auto_pytest_magic(server.get_button_font_size)
auto_pytest_magic(server.get_font_color)
